document.addEventListener("DOMContentLoaded", function () {
  ...
  if (loginForm) {
    loginForm.addEventListener("submit", function (e) {
      ...
      var passwordInput = loginForm.querySelector(
  ...
  // 2. Game Create / Edit Validation

  var gameForm = document.querySelector(
    'form[action*="/Games/Create"], form[action*="/Games/Edit"]',
  );
  if (gameForm) {
